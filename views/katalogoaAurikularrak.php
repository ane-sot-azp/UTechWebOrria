...
<body>
    ...
    <div class="general">
                ...
                <form>
                    <li>
                        <div class="accordion-item">
                            ...
                            <div class="accordion-content">
                                <?php
                                $sql = "SELECT marka FROM produktua WHERE ProduktuMota_idProduktuMota=4 GROUP BY marka";
                    ...
                    <li>
                        <div class="accordion-item">
                            ...
                            <div class="accordion-content">
                                <?php
                                $sql = "SELECT prozesagailua FROM produktua WHERE ProduktuMota_idProduktuMota=4 AND  prozesagailua IS NOT NULL GROUP BY prozesagailua";
                                $result = $conn->query($sql);
                    ...
                    <li>
                        <div class="accordion-item">
                            ...
                            <div class="accordion-content">
                                <?php
                                $sql = "SELECT tamaina FROM produktua WHERE ProduktuMota_idProduktuMota=4 AND  tamaina IS NOT NULL GROUP BY tamaina";
                                $result = $conn->query($sql);
                    ...
                    <li>
                        <div class="accordion-item">
                            ...
                            <div class="accordion-content">
                                <?php
                                $sql = "SELECT sistemaEragilea FROM produktua WHERE ProduktuMota_idProduktuMota=4 AND  sistemaEragilea IS NOT NULL GROUP BY sistemaEragilea";
                                $result = $conn->query($sql);
        ...
        <div class="produktuakKat">
            ...
            $sql = "SELECT idProduktua, irudia1, marka, modeloa, salmentaPrezioa FROM produktua where ProduktuMota_idProduktuMota=4";
            $result = $conn->query($sql);
